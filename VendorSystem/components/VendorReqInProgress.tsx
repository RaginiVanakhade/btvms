...
import { openBackdrop, closeBackdrop } from 'store/reducers/backdropSlice'; // Ensure the correct path to backdropSlice
  ...
  return (
    <div>
      <Box sx={{ width: '100%' }}>
        ...
        {filesDialogOpen && (
          <VendorFilesDialog requestNumber={requestData?.DOC_NO || ''} isViewMode={!isEditMode} onClose={() => setFilesDialogOpen(false)} />
        )}
      </Box>
    </div>
  );
